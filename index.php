<?php
  ...
  $person1 = new Bmi(['firstname'=>'Arjan', 'infix'=>'de', 'lastname'=>'Ruijter', 'bodymass'=>3, 'bodylength'=>1.8]);
  ...
  $person2 = new Bmi(['firstname'=>'Miranda', 'infix'=>'van', 'lastname'=>'Tegelen', 'bodylength'=>1.45]);
